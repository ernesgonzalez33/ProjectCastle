...
//        map.getLayers().get("Roof").setOpacity(0.9f); //TODO: (opcional) transparentar ciertas capas para que se vean los personajes
        ...
        number1 = new Hero(positionNumber1.x, positionNumber1.y, 10, 10, "Number1", 10, charactersRegions[0][0], this.game.actionMenu, 3);
        number2 = new Hero(positionNumber2.x, positionNumber2.y, 10, 10, "Number2", 10, charactersRegions[0][3], this.game.actionMenu, 3);
        theOne = new Enemy(positionTheOne.x, positionTheOne.y, 10, 10, "TheOne", 10, charactersRegions[0][9], this.game.actionMenu, 3);
